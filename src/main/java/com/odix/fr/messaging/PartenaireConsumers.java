...
public class PartenaireConsumers {
    ...
    public void addPartenaireConsumer(String message) throws IOException {
        System.out.print(String.format("#### -> addPartenaireConsumer : Notifications-MS  -> %s", message +"\n"));
    ...
    public void editPartenaireConsumer(String message) throws IOException {
        System.out.print(String.format("#### -> editPartenaireConsumer : Notifications-MS -> %s", message +"\n"));
    ...
    public void deletePartenaireConsumer(String message) throws IOException {
        System.out.print(String.format("#### -> deletePartenaireConsumer : Notifications-MS -> %s", message +"\n"));
