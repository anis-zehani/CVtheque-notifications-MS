...
public class NotificationController {
	...
	public void generateSimpleNotification(@RequestBody POJONotification pojoNotification)
	{
		...
		(
				pojoNotification.getObjetNotification(), 
				pojoNotification.getCorpsNotification(), 
				pojoNotification.getListeDestinatairesNotification(), 
				pojoNotification.getGenerateurNotification(), 
				pojoNotification.getCandidatNotification(), 
